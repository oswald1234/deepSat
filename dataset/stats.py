...
classCounts_s1={
    'test': {'1': torch.tensor([  63529,   20298,   73296,  198013,  581143,  604587,  182755,  504807,
            72177, 1148526,   69798,    7126,   63845,   65529,   20436,   16763,
           293644,  240926, 2620170,     162, 2426506,       0,       0, 8506021,
           189509,     371,  157988, 1336267], dtype=torch.int32)},
     'train': {'1': torch.tensor([  526894,   105177,   579921,  1578109,  4151708,  4319438,  1577352,
           4096943,   641177,  8893741,   597045,    64119,   439807,   722256,
            155162,   190228,  2248903,  2059679, 24698895,     3413, 20904924,
                 0,        0, 70976607,  1268213,    13201,  1535256, 10443256],
         dtype=torch.int32)},
     'val': {'1': torch.tensor([  67081,   20964,   91664,  214931,  475905,  464059,  196060,  585366,
            80674, 1126586,   76252,    5152,   67418,   93862,   28264,   25030,
           252370,  311659, 3154495,       0, 2518264,       0,       0, 8788978,
           173711,     957,  236936, 1325058], dtype=torch.int32)}}
...
quantiles_s1={
    'high': {
        '1':torch.tensor([-11.315226554870605, -4.897528648376465])
    },
    'low':{
        '1':torch.tensor([-29.945127487182617, -20.612838745117188])
    }
}
